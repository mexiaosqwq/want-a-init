...
export function apply(ctx) {
  ...
  // keep filling in and summarizing. This makes the maintenance behavior part of
  // the agent runtime, not just the one-shot /init command.
  ctx.inject(['systemPrompt'], (scope) => {
    scope.systemPrompt.section({
      name: 'agents-md-maintenance',
      order: 50,
      text: 'AGENTS.md maintenance: treat the current workspace\'s AGENTS.md as a living, repo-specific knowledge base. Whenever you discover verified commands, architecture facts, conventions, or pitfalls, update the matching section in AGENTS.md in place. Keep it concise and evidence-based; never create CLAUDE.md as a substitute.',
    })
  })
}
